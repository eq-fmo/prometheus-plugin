...
public class CoverageMethodCoveredGaugeTest extends CoverageTest {


    public CoverageMethodCoveredGaugeTest() {
    ...
    public void testCovered() {
        ...
        CoverageMethodCoveredGauge sut = new CoverageMethodCoveredGauge(new String[]{"job"}, getNamespace(), getSubSystem());
        ...
        Assertions.assertEquals("Returns the number of functions covered", familySamples.help);
        Assertions.assertEquals("default_jenkins_builds_coverage_method_covered", familySamples.name);
