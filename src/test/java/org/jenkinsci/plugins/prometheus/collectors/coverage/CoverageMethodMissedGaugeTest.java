...
class CoverageMethodMissedGaugeTest extends CoverageTest {


    public CoverageMethodMissedGaugeTest() {
    ...
    public void testMissed() {
        ...
        CoverageMethodMissedGauge sut = new CoverageMethodMissedGauge(new String[]{"job"}, getNamespace(), getSubSystem());
        ...
        Assertions.assertEquals("Returns the number of functions missed", familySamples.help);
        Assertions.assertEquals("default_jenkins_builds_coverage_method_missed", familySamples.name);
