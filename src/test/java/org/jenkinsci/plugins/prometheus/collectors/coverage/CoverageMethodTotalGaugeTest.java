...
class CoverageMethodTotalGaugeTest extends CoverageTest {


    public CoverageMethodTotalGaugeTest() {
    ...
    public void testMissed() {
        ...
        CoverageMethodTotalGauge sut = new CoverageMethodTotalGauge(new String[]{"job"}, getNamespace(), getSubSystem());
        ...
        Assertions.assertEquals("Returns the number of functions total", familySamples.help);
        Assertions.assertEquals("default_jenkins_builds_coverage_method_total", familySamples.name);
