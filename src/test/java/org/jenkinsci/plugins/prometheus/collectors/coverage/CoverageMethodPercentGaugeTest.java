...
public class CoverageMethodPercentGaugeTest extends CoverageTest {


    public CoverageMethodPercentGaugeTest() {
        super(Baseline.PROJECT, Metric.METHOD);
    }

    @Test
    public void testPercentage() {
        setUpSuccessfulMocksForPercent();
        CoverageMethodPercentGauge sut = new CoverageMethodPercentGauge(new String[]{"job"}, getNamespace(), getSubSystem());
        ...
        Assertions.assertEquals("Returns the coverage of functions in percent", familySamples.help);
        Assertions.assertEquals("default_jenkins_builds_coverage_method_percent", familySamples.name);
